...
public class MenuPrincipal {
    ...
    public void escolher() {
        ...
        while (rodando) {
            int instancia = InputManager.lerInteiro("Digite sua Opção> ", 1, 7);
            System.out.println();
            if (instancia == 1) {
    ...
    public void exibirmenu() {
        ...
        System.out.println(ConsoleColors.ORANGE + "[7]" + ConsoleColors.RESET + "Carregar Jogo");
        this.escolher();
    };
